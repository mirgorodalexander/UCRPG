...
namespace RayFire
{
    ...
    public class RFDemolitionCluster
    {
        ...
        public void DemolishClusterNested (RayfireRigid scr)
        {
        ...
        public void DemolishClusterConnected (RayfireRigid scr)
        {
            ...
            if (detachChildren.Count == cluster.shards.Count)
            {
                scr.limitations.demolished = true;
                return;
            }
            ...
            cluster.childClusters = RFCluster.ConnectivityCheck (cluster.shards);
        ...
        void CreateClusterRuntime (RayfireRigid scr, RFCluster cls)
        {
        ...
        void AddRigidComponent (RayfireRigid scr, List<Transform> tmList)
        {
